...
class ResponseGenerator:
    def __init__(self):
        self.model_normal = LLM_request(
            model=global_config.llm_normal, temperature=global_config.RESPONSE_TEMPERATURE, max_tokens=global_config.max_response_length, request_type="response_heartflow"
        )

        self.model_sum = LLM_request(
            model=global_config.llm_summary_by_topic, temperature=global_config.RESPONSE_TEMPERATURE, max_tokens=2000, request_type="relation"
        )
