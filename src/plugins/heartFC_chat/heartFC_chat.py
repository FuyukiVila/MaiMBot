...
class HeartFChatting:
    ...
    async def _build_planner_prompt(self, observed_messages_str: str, current_mind: Optional[str]) -> str:
        ...
        prompt += (
            ...
            "决策依据：\n"
            "1. 如果聊天内容无聊、与你无关、或者你的内心想法认为不适合回复（例如在讨论你不懂或不感兴趣的话题），选择 'no_reply'。但在群聊中，即使话题不是很感兴趣，也可以适当参与，保持群聊活跃。\n"
            ...
            "4. 如果最后一条消息是你自己发的，并且之后没有人回复你，可以考虑继续发言，特别是在群聊中，可以主动引导话题或提出新的话题。\n"
            "5. 在群聊中，可以适当附和或回应他人的发言，这有助于增加群聊的活跃度和互动性。\n"
            "6. 表情包是用来表达情绪的，不要直接回复或评价别人的表情包，而是根据对话内容和情绪选择是否用表情回应。\n"
            "7. 即使观察到的内容只有你自己的发言，在群聊中也可以考虑继续发言，引导话题或提出新的话题。\n"
            "8. 不要回复你自己的话，不要把自己的话当做别人说的。\n"
            "9. 在群聊中，要更积极主动地参与对话，不要过于被动等待他人回复。\n"
